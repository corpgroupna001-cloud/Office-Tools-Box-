...
(function () {
    ...
    const TOOLS = [
        ...
        { title: 'Friday Check-in', sub: 'WFH 3-clip video (mobile · laptop · tab)', icon: '📷', href: '/recordings/',tags: 'wfh friday check-in check in video camera workspace weekly record submit mobile laptop tab' },
