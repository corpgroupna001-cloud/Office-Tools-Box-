...
const READ_ONLY = new Set([
  ...
  'att_daily_report', 'att_logs', 'att_unmapped', 'att_selfies', 'att_scheduler_status',
  'crm_records', 'crm_unowned', 'crm_perm_load',
]);
...
const TITLES = {
  ...
  att_scheduler_run: 'Ran the shift-end attendance job',
  ...
  import_crm: 'Imported CRM records',
  crm_fill_company: 'Gave CRM records without a company to a company',
  crm_perm_save: 'Changed CRM access permissions',
};
